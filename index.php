...
// Filling log with breakfast values
...
// Filling log with first snack values
...
// Filling log with dinner values
...
// Filling log with second snack values
...
// Filling log with bedtime values
    ...
    <div class="w3-content">
        <div class="w3-twothird">
            ...
            <table class="log-table">
                <caption>
                    <h3>Check your blood sugar at
                        <?php
                        if (strcmp(date('l'), "Sunday") == 0
                            || strcmp(date('l'), "Thursday") == 0) {
                            echo "breakfast";
                        } else if (strcmp(date('l'), "Monday") == 0
                            || strcmp(date('l'), "Friday") == 0) {
                            echo "lunch";
                        } else if (strcmp(date('l'), "Tuesday") == 0
                            || strcmp(date('l'), "Saturday") == 0) {
                            echo "dinner";
                        } else {
                            echo "bedtime";
                        }
